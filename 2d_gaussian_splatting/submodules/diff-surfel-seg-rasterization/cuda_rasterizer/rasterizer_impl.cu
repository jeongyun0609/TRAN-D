	...
	bool debug)
{
	...
	const float* feature_ptr_seg = segs_precomp != nullptr ? segs_precomp : geomState.seg;
	...
	bool debug)
{
	...
	const float* seg_ptr = (segs_precomp != nullptr) ? segs_precomp : geomState.seg;
	const float* obj_ptr = shs_obj;
